...
if opt_seed:
    ...
    tf.compat.v1.set_random_seed(random.randint(0, 2 ** 32 - 1))  # tf.set_random_seed should be applied on the graph level!
num_cpus = multiprocessing.cpu_count()
print(" Number of CPUs: ", num_cpus)
session_config = tf.compat.v1.ConfigProto(device_count={"CPU": num_cpus},
